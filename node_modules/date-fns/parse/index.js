...
var _index5 = require('../subMinutes/index.js');
...
var _index9 = require('./_lib/parsers/index.js');
...
function parse(dirtyDateString, dirtyFormatString, dirtyBaseDate, dirtyOptions) {
  ...
  if (formatString === '') {
    if (dateString === '') {
      return (0, _index4.default)(dirtyBaseDate, options);
    } else {
      return new Date(NaN);
    }
  }
  ...
  for (i = 0; i < tokens.length; i++) {
    ...
    var parser = _index10.default[firstCharacter];
    if (parser) {
  ...
  var date = (0, _index4.default)(dirtyBaseDate, options);
  ...
  var utcDate = (0, _index6.default)(date, date.getTimezoneOffset());
